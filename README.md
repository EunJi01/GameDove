...
* SearchView에서 panGesture를 통해 창 내리기
* GamesView는 세그먼트로 나눌까...? 좋아보인다...!
* 메인 플랫폼 변경 모달로 해볼까...? 좋아보인다...!
#### 업데이트 (하고싶은...) 기능
...
* 로딩 중 네비게이션 바 조작 막기...?
* 재사용 에러 있는 것 같음 (이미지 한박자 늦게 바뀜!) 해결하기
-------------
...
| 23 | RatingGameView | periodMenu 이미지 체크박스 추가 | 3h |  |  |
| 24 | API 통신 | 네트워크 상태에 따른 대응 | 4h |  |  |
| 25 | 기능 개선 | 오픈API 호출횟수 개선 | 3h |  |  |
|  |  |  |  |  |  |
...
|  | 추가 기능 | 보관함 출시예정작 출시일 노티 | 3h |  |  |
|  | 기능 개선 | 네트워크 통신 시간 단축 | 4h |  |  |
|  |  |  |  |  |  |
